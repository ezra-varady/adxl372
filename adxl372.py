...
class ADXL372:
    def __init__(self, major, minor):
        ...
        self.fifo_mode = FIFOMode.BYPASSED
        self.fifo_format = FIFOFormat.XYZ_FIFO
    ...
    def set_op_mode(self, mode: OP_MODES):
        ...
        """
        self.update(ADI_ADXL372_POWER_CTL, PWRCTRL_OPMODE_MASK, 0, mode)
        self.op_mode = mode
    ...
    def set_ODR(self, odr: ODR):
        ...
        """
        self.update(ADI_ADXL372_TIMING, TIMING_ODR_MASK, TIMING_ODR_POS, odr)
        self.odr = odr
    ...
    def set_bandwidth(self, bandwidth: BW):
        ...
        """
        self.update(ADI_ADXL372_MEASURE, MEASURE_BANDWIDTH_MASK, 0, bandwidth)
        self.bw = bandwidth
    ...
    def set_wakeup_rate(self, rate: WUR):
        ...
        """
        self.update(ADI_ADXL372_TIMING, TIMING_WUR_MASK, TIMING_WUR_POS, rate)
    ...
    def set_activity_processing_mode(self, mode: ActivityMode):
        ...
        """
        self.update(
            ADI_ADXL372_MEASURE, MEASURE_ACTPROC_MASK, MEASURE_ACTPROC_POS, mode
        )
    ...
    def set_filter_settle(self, mode: FilterSettle):
        ...
        """
        self.update(
            ADI_ADXL372_POWER_CTL,
            PWRCTRL_FILTER_SETTLE_MASK,
            PWRCTRL_FILTER_SETTLE_POS,
            mode,
        )
    ...
    def set_instant_on_thresh(self, mode: InstantOnThresh):
        ...
        """
        self.update(
            ADI_ADXL372_POWER_CTL, PWRCTRL_INSTAON_THRESH_MASK, INSTAON_THRESH_POS, mode
        )
    ...
    def set_activity_time(self, duration_ms: int):
        ...
        w_val = int(w_val + 0.5)  # Bootleg positive integer rounding
    ...
    def configure_fifo(
        self, samples: int, mode: FIFOMode, qformat: FIFOFormat
        ...
        config = (
            (mode << FIFO_CRL_MODE_POS)
            | (qformat << FIFO_CRL_FORMAT_POS)
            | (samples_MSB << FIFO_CRL_SAMP8_POS)
        )
